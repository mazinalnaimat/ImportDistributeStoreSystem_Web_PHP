...
(18, 'وسط البلد 2', 2, '2026-07-15 21:13:02', '2342348879', 'albalad2@alofoq.com', 'Amman - Down Town', '9bb5a8e4-3873-40e6-ab6b-20f2c2755062.png');
...
(15, 15, 1, 2, '2026-07-08 15:00:00', '2026-07-12 14:30:00', 20, 150.00),
(14, 15, 1, 1, '2026-07-07 13:20:00', '2026-07-11 12:45:00', 10, 150.00),
(13, 14, 1, 1, '2026-07-06 11:45:00', '2026-07-09 10:15:00', 18, 920.00),
(12, 15, 10, 1, '2026-07-05 10:30:00', '2026-07-08 09:00:00', 30, 160.00),
(11, 15, 2, 2, '2026-07-04 09:10:00', '2026-07-06 08:30:00', 20, 150.00),
(16, 14, 3, 1, '2026-07-10 09:30:00', '2026-07-13 16:00:00', 30, 950.00),
(17, 13, 10, 1, '2026-07-15 16:30:42', '2026-07-18 17:30:00', 50, 1000.00),
(18, 14, 10, 1, '2026-07-15 16:38:54', '2026-07-18 20:38:00', 12, 930.00),
(19, 24, 2, 1, '2026-07-15 21:14:01', '2026-07-16 21:13:00', 30, 55.00),
...
INSERT INTO `notes` (`NoteId`, `CreatedUserId`, `CreatedDateTime`, `Title`, `Text`) VALUES
(12, 2, '2026-06-02 14:30:00', 'وصول شحنة جديدة', 'وصلت اليوم شحنة جديدة من الهواتف المحمولة وأجهزة اللابتوب إلى المستودع الرئيسي. تم الانتهاء من فحص الكميات، وسيتم توزيع الأجهزة على الفروع صباح الغد حسب احتياج كل فرع.'),
(13, 1, '2026-06-05 10:20:00', 'طلب فرع إربد', 'فرع إربد طلب كمية إضافية من سماعات البلوتوث والشواحن بسبب زيادة المبيعات خلال الأسبوع الحالي. يرجى تجهيز الطلب وإرساله مع الشحنة القادمة.'),
(14, 1, '2026-07-10 10:40:00', 'ملاحظة على الشحنة', 'أثناء استلام شحنة الشاشات تم العثور على صندوق يحتوي على شاشة متضررة. تم فصلها عن باقي الكمية وإبلاغ المورد لإرسال بديل في أقرب وقت.'),
(15, 2, '2026-07-12 09:03:00', 'نقص في المخزون', 'مخزون أجهزة اللابتوب المخصصة للألعاب في المستودع الرئيسي أصبح منخفضاً. يفضل إضافتها إلى طلبية الاستيراد القادمة لتلبية طلبات الفروع.'),
(16, 3, '2026-07-14 12:07:20', 'تجهيز طلبات الفروع', 'تم الانتهاء من تجهيز طلبات فروع عمان والزرقاء والعقبة، وتشمل هواتف، أجهزة كمبيوتر، طابعات، وإكسسوارات. الشحنة جاهزة للتحميل وسيتم إرسالها اليوم.');
