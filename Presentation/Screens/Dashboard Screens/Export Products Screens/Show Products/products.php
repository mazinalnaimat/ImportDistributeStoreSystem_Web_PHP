...
$ActionFilePath = "../../../../actions/products_action.php";
...
<html lang="ar" dir="rtl">
    ...
    <main class="container">
                    ...
                    <div>
                        <form method="GET" action="<?= $ActionFilePath ?>">
                            ...
                            <select name="order_by" class="form-select bg-dark text-light border-secondary"
                                    onchange="this.form.submit()">
                                <?php $OrderBy = $_SESSION["PageVars"]['ColNameForOrderBy'] ?? 'PurchasedProductName'; ?>
                    ...
                    <div>
                        <form method="GET" action="<?= $ActionFilePath ?>">
                            ...
                            <select name="available_product_filter" class="form-select bg-dark text-light border-secondary"
                                ...
                                <?php $Filter = $_SESSION["PageVars"]['AvailableProductFilter'] ?? 'all'; ?>
        ...
        <?php if(isset($_SESSION["PageVars"]['PurchasedProductDetailsId'])): ?>

        <?php 
            $Product = $_SESSION["PageVars"]['PurchasedProductDetailsId'];
        ...
        <?php $PurchasedProducts = $_SESSION["PageVars"]['PurchasedProducts'] ?? [];?>
        <?php if ($ViewMode === 'Cards'): ?>
            <!-- Cards View -->
