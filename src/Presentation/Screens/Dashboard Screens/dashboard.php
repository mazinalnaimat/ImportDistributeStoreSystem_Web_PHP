...
<html>
    ...
    <body dir="rtl"> <!-- RTL for Arabic -->
        ...
        <main class="container">
            ...
            <div class="row g-4 dashboard-grid justify-content-center align-items-stretch">

                <!-- 1- Imported Goods -->
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    <a href="import_products.php" class="dashboard-card text-decoration-none w-100">
                ...
                <!-- 2- Exported Goods -->
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    <a href="export_products.php" class="dashboard-card text-decoration-none w-100">
                        <div class="card bg-dark text-light shadow-lg h-100">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <!-- 3- Our Branches -->
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    <a href="branches.php" class="dashboard-card text-decoration-none w-100">
                        <div class="card bg-dark text-light shadow-lg h-100">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <!-- 4- Statistics -->
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    <a href="statistics.php" class="dashboard-card text-decoration-none w-100">
                        <div class="card bg-dark text-light shadow-lg h-100">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <!-- 5- Search -->
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    <a href="search.php" class="dashboard-card text-decoration-none w-100">
                        <div class="card bg-dark text-light shadow-lg h-100">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
